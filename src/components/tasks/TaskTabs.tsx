...
import type { TaskTabKey } from '@/types';

export type TaskTabItem = { key: TaskTabKey; label: string; count: number };

type Props = {
  tabs: TaskTabItem[];
  activeKey: TaskTabKey;
  onChange: (key: TaskTabKey) => void;
};

export const TaskTabs = ({ tabs, activeKey, onChange }: Props) => {
